...
![Implement the schematic](img/langchain+chatglm.png)

The main process analysis from the aspect of document process:

![Implement schematic 2](img/langchain+chatglm2.png)
...
# The default dependency includes the basic runtime environment (FAISS vector library). If you want to use a vector library such as milvus/pg_vector, uncomment the corresponding dependency in the requirements.txt and install it.
```
