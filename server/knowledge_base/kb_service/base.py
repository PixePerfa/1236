...
def normalize(embeddings: List[List[float]]) -> np.ndarray:
    '''
    sklearn.preprocessing.normalize (using L2) and avoid installing scipy, scikit-learn
    '''
...
class KBService(ABC):
    ...
    def __init__(self,
        ...
        self.kb_info = KB_INFO.get(knowledge_base_name, f"Knowledge base on {knowledge_base_name}")
    ...
    def save_vector_store(self):
        '''
        Save vector library: FAISS is saved to disk, and milvus is saved to the database. PGVector is not supported
        '''
        pass
    ...
    def clear_vs(self):
        """
        Delete everything in the vector library
        """
        self.do_clear_vs()
    ...
    def _docs_to_embeddings(self, docs: List[Document]) -> Dict:
        '''
        Convert List[Document] to an acceptable parameter for VectorStore.add_embeddings
        '''
    ...
    def add_doc(self, kb_file: KnowledgeFile, docs: List[Document] = [], **kwargs):
        ...
        If docs is specified, the text is no longer vectorized and the database corresponding bar target is custom_docs=True
        """
        if docs:
            custom_docs = True
            for doc in docs:
    ...
    def delete_doc(self, kb_file: KnowledgeFile, delete_content: bool = False, **kwargs):
        """
        Delete the file from the knowledge base
        """
    ...
    def update_info(self, kb_info: str):
        """
        Updated the knowledge base introduction
        """
    ...
    def update_doc(self, kb_file: KnowledgeFile, docs: List[Document] = [], **kwargs):
        """
        Update the vector library with the files in the content
        If docs is specified, the custom docs is used and the target of the corresponding database is custom_docs=True
        """
    ...
    def update_doc_by_ids(self, docs: Dict[str, Document]) -> bool:
        '''
        The input parameter is: {doc_id: Document, ...}
        If the value of the corresponding doc_id is None, or its page_content is empty, the document is deleted
        '''
    ...
    def list_docs(self, file_name: str = None, metadata: Dict = {}) -> List[DocumentWithVSId]:
        ...
        for x in doc_infos:
            ...
            if doc_info is not None:
                ...
                # Handle empty cases
                # You can choose to skip the current loop iteration or perform other actions
                pass
        return docs

    def get_relative_source_path(self,filepath: str):
      '''
      Convert file paths to relative paths to ensure consistency in queries
      '''
    ...
    def do_create_kb(self):
        """
        Create knowledge base subclasses to implement your own logic
        """
        pass
    ...
    def do_drop_kb(self):
        """
        Removing the knowledge base subclass implements its own logic
        """
        pass
    ...
    def do_search(self,
        ...
        """
        Search the knowledge base subclass to implement your own logic
        """
        pass
    ...
    def do_delete_doc(self,
        ...
        """
        Removing a document subclass from the knowledge base implements its own logic
        """
        pass
    ...
    def do_clear_vs(self):
        """
        Remove all to quantum-like realizations from the knowledge base
        """
        pass
...
class EmbeddingsFunAdapter(Embeddings):
    ...
    def embed_query(self, text: str) -> List[float]:
        ...
        query_embed_2d = np.reshape(query_embed, (1, -1)) # Convert a one-dimensional array to a two-dimensional array
        normalized_query_embed = normalize(query_embed_2d)
        return normalized_query_embed[0].tolist() # converts the result to a one-dimensional array and returns
