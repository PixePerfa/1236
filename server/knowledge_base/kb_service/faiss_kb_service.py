...
class FaissKBService(KBService):
    ...
    def do_add_doc(self,
        ...
        data = self._docs_to_embeddings(docs) # Separating vectorization can reduce the lock time of the vector library
...
if __name__ == '__main__':
    ...
    print(faissService.search_docs("How to start an API service"))
