...
class MiniMaxWorker(ApiModelWorker):
    ...
    def do_chat(self, params: ApiChatParams) -> Dict:
        # According to the recommendation on the official website, directly call the abab 5.5 model
        ...
        data = {
            ...
            # The following parameters are specific to minimax, and an error will be given when a null value is passed.
            ...
            with response as r:
                ...
                for e in r.iter_text():
                    if not e.startswith("data: "):
                        data = {
                                "error_code": 500,
                                "text": f"minimax returns an incorrect result: {e}",
                                "error": {
                                    "message": f"minimax returns an incorrect result: {e}",
    ...
    def make_conv_template(self, conv_template: str = None, model_path: str = None) -> Conversation:
        return conv. Conversation(
            ...
            system_message="You are a large language model independently developed by MiniMax, and your answers to questions are concise and organized. ",
            messages=[],
            roles=["USER", "BOT"],
            sep="\n### ",
            stop_str="###",
